package com.shynieke.playerstatues.client.model;
...
public class PlayerStatueModel extends PlayerModel<PlayerStatuesStatue> {
	...
	@Override
	public void setupAnim(PlayerStatuesStatue entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
